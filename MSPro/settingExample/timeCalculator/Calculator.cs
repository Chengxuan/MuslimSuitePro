...
namespace PrayerTimesCalculator
{
    public class Calculator
    {
        ...
        public void setOffSets(double f, double d, double a, double m, double i)
        {
            _offsets[TimeNames.Imsak] = 0;
            _offsets[TimeNames.Fajr] = f;
            _offsets[TimeNames.Sunrise] = 0;
            _offsets[TimeNames.Dhuhur] = d;
            _offsets[TimeNames.Asr] = a;
            _offsets[TimeNames.Sunset] = 0;
            _offsets[TimeNames.Magrib] = m;
            _offsets[TimeNames.Isha] = i;
