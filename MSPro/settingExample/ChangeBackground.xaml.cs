...
namespace MuslimSuitePro
{
    ...
    {
        Border previouslySelect = new Border(); // to store the brush of the image which was previously in selected queue
        Image newSelectedImage = new Image(); // to store the reference of the newely seleted image
        int argument = 0;
        ...
        private async void saveSelection_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (newSelectedImage.Source == null)
            {
